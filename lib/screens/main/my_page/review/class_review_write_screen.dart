...
class ClassReviewWriteScreen extends StatefulWidget {
  final Map<String, dynamic>? classData;

  const ClassReviewWriteScreen({super.key, this.classData});

  @override
  State<ClassReviewWriteScreen> createState() => _ClassReviewWriteScreenState();
}

class _ClassReviewWriteScreenState extends State<ClassReviewWriteScreen> {
  // 질문 답변 상태
