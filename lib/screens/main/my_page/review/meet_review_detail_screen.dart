...
class MeetReviewDetailScreen extends StatelessWidget {
  final Map<String, dynamic>? reviewData;

  const MeetReviewDetailScreen({super.key, this.reviewData});
  ...
  Widget build(BuildContext context) {
    ...
    final review =
        reviewData ??
        {
          ...
          'reviewText': '좋은 만남이었습니다!',
        };

    final meet = review['meet'] as Map<String, dynamic>? ?? {};
    final answers = review['answers'] as Map<String, dynamic>? ?? {};

    return Scaffold(
      backgroundColor: AppColors.white,
      appBar: AppBarWidget(title: '만남 후기', isBackButton: true),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // 만남 정보 카드
            ReviewCardWidget(
              review: _convertToReviewData(meet),
              isClassType: false,
              showButton: false,
            ),
            ...
            Column(
              ...
              children: [
                // 질문 1: 만남에 참석하셨나요?
                _buildQuestionWithAnswer('만남에 참석 하셨나요?', [
                  '참석 했어요.',
                  '참석하지 못했어요.',
                ...
                // 질문 3: 비즈니스에 도움이 되었나요?
                _buildQuestionWithAnswer('이번 비즈만남이 비즈니스에 도움이 되었나요?', [
                  '도움 되었어요.',
                  '보통 이였어요.',
                  '그렇지 않았어요.',
                ], answers['businessHelp'] as int? ?? 0),
                // 질문 4: 다음 만남을 기대하나요?
                _buildQuestionWithAnswer('이번 만남 멤버로 다음 모임/만남을 기대하나요?', [
                  '기대해요.',
                  '보통 이였어요.',
                  '그렇지 않았어요.',
  ...
  Map<String, dynamic> _convertToReviewData(Map<String, dynamic> meet) {
    return {
      'NAME': meet['name'],
